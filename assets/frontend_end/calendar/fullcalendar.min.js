...
(function(e, t) {
    ...
    function s(n, r) {
        ...
        function b(e) {
            var r = e.source || {},
                i = Y(r.ignoreTimezone, n.ignoreTimezone);
    ...
    function f(e, t) {
        if (+e)
            for (; e.getDate() != t.getDate();) e.setTime(+e + (e < t ? 1 : -1) * Nt)
    }
    ...
    function ot(n, r, i) {
        ...
        var et = Z.opt,
            ...
            lt = Z.slotSegHtml,
            vt = r.formatDate,
            gt, yt, bt, wt, Et, St, xt, Tt, Nt, Ct, kt, Lt, At, Ot, Mt, _t, Dt, Pt, Ht, Bt, jt, Ft, It, qt, Rt, Ut, zt, Wt, Xt, Vt, $t, Jt, Kt = {},
            Qt, Gt, Yt, Zt, en, tn, nn, rn, sn;
    ...
    function lt() {
        ...
        function r(t, n, r) {
            ...
            for (u = 0; u < a; u++)
                if (h = t[u].element) t[u].row === n && h.css("top", r), o.push(h[0]);
            return e(o)
        }
...
/*var Flights = new Array('Emirates', 'Jet Airways');

var s_a = new Array();
s_a[0]="51000|53000|56500|65500";
s_a[1]="55000|57000|60500|69500";

var select = document.getElementById("flightsPayment");
$(document).on("click", ".calendarBtn", function() {
    $("#BackToday").addClass("calendarOn");

    if ($("#BackToday").hasClass("calendarOn")) {
        $(".half-input").removeClass("half-input").addClass("fiveBox");
        $("#flights").css("display", "inline-block");
    } else {
        $(".half-input").removeClass("fiveBox").addClass("half-input");
        $("#flights").css("display", "none");
    }
    for (index in Flights) {
        select.options[select.options.length] = new Option(Flights[index], s_a[index]);
    }

$("#flightsPayment").change(function(){
        var FinalValue = $(this).find("option:selected").val().split('|');
		for (index in FinalValue) {
        $(".shareSelect option:eq("+index+")").attr("data-receipt", FinalValue[index]);
    }
    });
});*/